    ...
    pub fn new(metrics: &Metrics) -> Self {
        ...
        Self {
            ...
            oldest_snapshot_time: metrics.gauge_vec(MetricOpts::new(
                "rocksdb_oldest_snapshot_time_seconds",
